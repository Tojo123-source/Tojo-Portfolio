      ...
      >
        ...
        <div className="relative w-full max-w-[1400px] mx-auto px-6 lg:px-12 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              href="/cv/tojo-nambinina-cv.pdf"
              download
              className="px-4 py-2 rounded-xl border border-[rgba(255,255,255,0.2)] text-[0.8125rem] font-medium text-[#f5ebe0] hover:bg-[rgba(255,255,255,0.08)] hover:border-[rgba(255,255,255,0.4)] transition-all duration-200 flex items-center gap-2"
            >
              <Download size={14} />
              CV
            </a>
